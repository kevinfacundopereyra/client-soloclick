...
const UserRegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ SOLUCIÓN: Si el registro es exitoso, redirigir independientemente del token
      if (response.success) {
        console.log("✅ Registro exitoso - redirigiendo al home");

        // Si hay token y usuario, guardar sesión
        ...
        alert("¡Usuario registrado exitosamente! Bienvenido a SoloClick");
        ...
        setError(
          response.message || "Error en el registro. Intenta nuevamente."
        );
      }
    } catch (error: any) {
